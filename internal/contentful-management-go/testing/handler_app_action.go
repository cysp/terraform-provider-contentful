...
func (ts *Handler) GetAppActions(_ context.Context, params cm.GetAppActionsParams) (cm.GetAppActionsRes, error) {
	...
	// Stable fixture ordering; the provider independently sorts discovery results.
...
// Updates construct a complete replacement, so omitted optional fields are cleared.
