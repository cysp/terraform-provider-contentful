...
type Invoker interface {
	...
	// CreateAppKey invokes createAppKey operation.
	//
	// Create an app key.
	//
	// POST /organizations/{organization_id}/app_definitions/{app_definition_id}/keys
	CreateAppKey(ctx context.Context, request *AppKeyRequestData, params CreateAppKeyParams, options ...RequestOption) (CreateAppKeyRes, error)
	...
	// CreateLocale invokes createLocale operation.
	//
	// Create a locale.
	//
	// POST /spaces/{space_id}/environments/{environment_id}/locales
	CreateLocale(ctx context.Context, request *LocaleData, params CreateLocaleParams, options ...RequestOption) (CreateLocaleRes, error)
	...
	// CreatePreviewEnvironment invokes createPreviewEnvironment operation.
	//
	...
	// DeleteAppAction invokes deleteAppAction operation.
	//
	// DELETE /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
	DeleteAppAction(ctx context.Context, params DeleteAppActionParams, options ...RequestOption) (DeleteAppActionRes, error)
	...
	// DeleteAppKey invokes deleteAppKey operation.
	//
	// Delete an app key.
	//
	// DELETE /organizations/{organization_id}/app_definitions/{app_definition_id}/keys/{key_kid}
	DeleteAppKey(ctx context.Context, params DeleteAppKeyParams, options ...RequestOption) (DeleteAppKeyRes, error)
	...
	// DeleteLocale invokes deleteLocale operation.
	//
	// Delete a locale.
	//
	// DELETE /spaces/{space_id}/environments/{environment_id}/locales/{locale_id}
	DeleteLocale(ctx context.Context, params DeleteLocaleParams, options ...RequestOption) (DeleteLocaleRes, error)
	...
	DeletePreviewEnvironment(ctx context.Context, params DeletePreviewEnvironmentParams, options ...RequestOption) (DeletePreviewEnvironmentRes, error)
	...
	// GetAppAction invokes getAppAction operation.
	//
	// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
	GetAppAction(ctx context.Context, params GetAppActionParams, options ...RequestOption) (GetAppActionRes, error)
	// GetAppActions invokes getAppActions operation.
	//
	// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/actions
	GetAppActions(ctx context.Context, params GetAppActionsParams, options ...RequestOption) (GetAppActionsRes, error)
	...
	// GetAppKey invokes getAppKey operation.
	//
	// Get one app key.
	//
	...
	// GetEnvironmentAliases invokes getEnvironmentAliases operation.
	//
	// Read EnvironmentAlias collection.
	//
	// GET /spaces/{space_id}/environment_aliases
	GetEnvironmentAliases(ctx context.Context, params GetEnvironmentAliasesParams, options ...RequestOption) (GetEnvironmentAliasesRes, error)
	// GetEnvironments invokes getEnvironments operation.
	//
	// Read Environment collection.
	//
	// GET /spaces/{space_id}/environments
	GetEnvironments(ctx context.Context, params GetEnvironmentsParams, options ...RequestOption) (GetEnvironmentsRes, error)
	...
	// GetLocale invokes getLocale operation.
	//
	// Read Locale.
	//
	// GET /spaces/{space_id}/environments/{environment_id}/locales/{locale_id}
	GetLocale(ctx context.Context, params GetLocaleParams, options ...RequestOption) (GetLocaleRes, error)
	// GetLocales invokes getLocales operation.
	//
	// Read Locale collection.
	//
	// GET /spaces/{space_id}/environments/{environment_id}/locales
	GetLocales(ctx context.Context, params GetLocalesParams, options ...RequestOption) (GetLocalesRes, error)
	...
	// GetPreviewEnvironment invokes getPreviewEnvironment operation.
	//
	// Get a content preview platform.
	//
	// GET /spaces/{space_id}/preview_environments/{preview_environment_id}
	GetPreviewEnvironment(ctx context.Context, params GetPreviewEnvironmentParams, options ...RequestOption) (GetPreviewEnvironmentRes, error)
	...
	//
	// GET /spaces/{space_id}
	GetSpace(ctx context.Context, params GetSpaceParams, options ...RequestOption) (GetSpaceRes, error)
	...
	//
	// GET /spaces
	GetSpaces(ctx context.Context, params GetSpacesParams, options ...RequestOption) (GetSpacesRes, error)
	...
	GetTeams(ctx context.Context, params GetTeamsParams, options ...RequestOption) (GetTeamsRes, error)
	...
	// PutLocale invokes putLocale operation.
	//
	// Update a locale.
	//
	// PUT /spaces/{space_id}/environments/{environment_id}/locales/{locale_id}
	PutLocale(ctx context.Context, request *LocaleData, params PutLocaleParams, options ...RequestOption) (PutLocaleRes, error)
	...
	PutPreviewEnvironment(ctx context.Context, request *PreviewEnvironmentData, params PutPreviewEnvironmentParams, options ...RequestOption) (PutPreviewEnvironmentRes, error)
	...
	// UpdateAppAction invokes updateAppAction operation.
	//
	// PUT /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
	UpdateAppAction(ctx context.Context, request *AppActionData, params UpdateAppActionParams, options ...RequestOption) (UpdateAppActionRes, error)
...
func (c *Client) sendCreateAppAction(ctx context.Context, request *AppActionData, params CreateAppActionParams, requestOptions ...RequestOption) (res CreateAppActionRes, err error) {
	...
	if err := encodeCreateAppActionRequest(request, r); err != nil {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, CreateAppActionOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeCreateAppActionResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// POST /organizations/{organization_id}/app_definitions/{app_definition_id}/keys
func (c *Client) CreateAppKey(ctx context.Context, request *AppKeyRequestData, params CreateAppKeyParams, options ...RequestOption) (CreateAppKeyRes, error) {
	res, err := c.sendCreateAppKey(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendCreateAppKey(ctx context.Context, request *AppKeyRequestData, params CreateAppKeyParams, requestOptions ...RequestOption) (res CreateAppKeyRes, err error) {
	...
	if err := encodeCreateAppKeyRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, CreateAppKeyOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeCreateAppKeyResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// POST /spaces/{space_id}/environments/{environment_id}/locales
func (c *Client) CreateLocale(ctx context.Context, request *LocaleData, params CreateLocaleParams, options ...RequestOption) (CreateLocaleRes, error) {
	res, err := c.sendCreateLocale(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendCreateLocale(ctx context.Context, request *LocaleData, params CreateLocaleParams, requestOptions ...RequestOption) (res CreateLocaleRes, err error) {
	...
	if err := encodeCreateLocaleRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, CreateLocaleOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeCreateLocaleResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
func (c *Client) sendCreatePreviewEnvironment(ctx context.Context, request *PreviewEnvironmentData, params CreatePreviewEnvironmentParams, requestOptions ...RequestOption) (res CreatePreviewEnvironmentRes, err error) {
	...
	pathParts[2] = "/preview_environments"
	uri.AddPathParts(u, pathParts[:]...)
	...
	if err := encodeCreatePreviewEnvironmentRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, CreatePreviewEnvironmentOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeCreatePreviewEnvironmentResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// DELETE /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
func (c *Client) DeleteAppAction(ctx context.Context, params DeleteAppActionParams, options ...RequestOption) (DeleteAppActionRes, error) {
	res, err := c.sendDeleteAppAction(ctx, params, options...)
	return res, err
}

func (c *Client) sendDeleteAppAction(ctx context.Context, params DeleteAppActionParams, requestOptions ...RequestOption) (res DeleteAppActionRes, err error) {
	...
	pathParts[4] = "/actions/"
	{
		// Encode "app_action_id" parameter.
		e := uri.NewPathEncoder(uri.PathEncoderConfig{
			Param:   "app_action_id",
			Style:   uri.PathStyleSimple,
			Explode: false,
		...
		if err := func() error {
			return e.EncodeValue(conv.StringToString(params.AppActionID))
		}(); err != nil {
			return res, errors.Wrap(err, "encode path")
		}
		encoded, err := e.Result()
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, DeleteAppActionOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeDeleteAppActionResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// DELETE /organizations/{organization_id}/app_definitions/{app_definition_id}/keys/{key_kid}
func (c *Client) DeleteAppKey(ctx context.Context, params DeleteAppKeyParams, options ...RequestOption) (DeleteAppKeyRes, error) {
	res, err := c.sendDeleteAppKey(ctx, params, options...)
	return res, err
}

func (c *Client) sendDeleteAppKey(ctx context.Context, params DeleteAppKeyParams, requestOptions ...RequestOption) (res DeleteAppKeyRes, err error) {
	...
	pathParts[4] = "/keys/"
	{
		...
		if err := func() error {
			return e.EncodeValue(conv.StringToString(params.KeyKid))
		}(); err != nil {
			return res, errors.Wrap(err, "encode path")
		}
		encoded, err := e.Result()
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, DeleteAppKeyOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeDeleteAppKeyResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
func (c *Client) DeleteLocale(ctx context.Context, params DeleteLocaleParams, options ...RequestOption) (DeleteLocaleRes, error) {
	res, err := c.sendDeleteLocale(ctx, params, options...)
	return res, err
}

func (c *Client) sendDeleteLocale(ctx context.Context, params DeleteLocaleParams, requestOptions ...RequestOption) (res DeleteLocaleRes, err error) {
	...
	pathParts[4] = "/locales/"
	{
		...
		if err := func() error {
			return e.EncodeValue(conv.StringToString(params.LocaleID))
		}(); err != nil {
			return res, errors.Wrap(err, "encode path")
		}
		encoded, err := e.Result()
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, DeleteLocaleOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeDeleteLocaleResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// DELETE /spaces/{space_id}/preview_environments/{preview_environment_id}
func (c *Client) DeletePreviewEnvironment(ctx context.Context, params DeletePreviewEnvironmentParams, options ...RequestOption) (DeletePreviewEnvironmentRes, error) {
	res, err := c.sendDeletePreviewEnvironment(ctx, params, options...)
	return res, err
}

func (c *Client) sendDeletePreviewEnvironment(ctx context.Context, params DeletePreviewEnvironmentParams, requestOptions ...RequestOption) (res DeletePreviewEnvironmentRes, err error) {
	...
	pathParts[2] = "/preview_environments/"
	{
		// Encode "preview_environment_id" parameter.
		e := uri.NewPathEncoder(uri.PathEncoderConfig{
		...
		if err := func() error {
			return e.EncodeValue(conv.StringToString(params.PreviewEnvironmentID))
		}(); err != nil {
			return res, errors.Wrap(err, "encode path")
		}
		encoded, err := e.Result()
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, DeletePreviewEnvironmentOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeDeletePreviewEnvironmentResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
func (c *Client) GetAppAction(ctx context.Context, params GetAppActionParams, options ...RequestOption) (GetAppActionRes, error) {
	res, err := c.sendGetAppAction(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetAppAction(ctx context.Context, params GetAppActionParams, requestOptions ...RequestOption) (res GetAppActionRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetAppActionOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeGetAppActionResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/actions
func (c *Client) GetAppActions(ctx context.Context, params GetAppActionsParams, options ...RequestOption) (GetAppActionsRes, error) {
	res, err := c.sendGetAppActions(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetAppActions(ctx context.Context, params GetAppActionsParams, requestOptions ...RequestOption) (res GetAppActionsRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetAppActionsOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeGetAppActionsResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/keys/{key_kid}
func (c *Client) GetAppKey(ctx context.Context, params GetAppKeyParams, options ...RequestOption) (GetAppKeyRes, error) {
	res, err := c.sendGetAppKey(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetAppKey(ctx context.Context, params GetAppKeyParams, requestOptions ...RequestOption) (res GetAppKeyRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetAppKeyOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeGetAppKeyResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
func (c *Client) GetAppKeys(ctx context.Context, params GetAppKeysParams, options ...RequestOption) (GetAppKeysRes, error) {
	res, err := c.sendGetAppKeys(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetAppKeys(ctx context.Context, params GetAppKeysParams, requestOptions ...RequestOption) (res GetAppKeysRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetAppKeysOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeGetAppKeysResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /spaces/{space_id}/environment_aliases
func (c *Client) GetEnvironmentAliases(ctx context.Context, params GetEnvironmentAliasesParams, options ...RequestOption) (GetEnvironmentAliasesRes, error) {
	res, err := c.sendGetEnvironmentAliases(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetEnvironmentAliases(ctx context.Context, params GetEnvironmentAliasesParams, requestOptions ...RequestOption) (res GetEnvironmentAliasesRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetEnvironmentAliasesOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeGetEnvironmentAliasesResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /spaces/{space_id}/environments
func (c *Client) GetEnvironments(ctx context.Context, params GetEnvironmentsParams, options ...RequestOption) (GetEnvironmentsRes, error) {
	res, err := c.sendGetEnvironments(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetEnvironments(ctx context.Context, params GetEnvironmentsParams, requestOptions ...RequestOption) (res GetEnvironmentsRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetEnvironmentsOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) GetLocale(ctx context.Context, params GetLocaleParams, options ...RequestOption) (GetLocaleRes, error) {
	res, err := c.sendGetLocale(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetLocale(ctx context.Context, params GetLocaleParams, requestOptions ...RequestOption) (res GetLocaleRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetLocaleOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeGetLocaleResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /spaces/{space_id}/environments/{environment_id}/locales
func (c *Client) GetLocales(ctx context.Context, params GetLocalesParams, options ...RequestOption) (GetLocalesRes, error) {
	res, err := c.sendGetLocales(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetLocales(ctx context.Context, params GetLocalesParams, requestOptions ...RequestOption) (res GetLocalesRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetLocalesOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeGetLocalesResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /spaces/{space_id}/preview_environments/{preview_environment_id}
func (c *Client) GetPreviewEnvironment(ctx context.Context, params GetPreviewEnvironmentParams, options ...RequestOption) (GetPreviewEnvironmentRes, error) {
	res, err := c.sendGetPreviewEnvironment(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetPreviewEnvironment(ctx context.Context, params GetPreviewEnvironmentParams, requestOptions ...RequestOption) (res GetPreviewEnvironmentRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetPreviewEnvironmentOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeGetPreviewEnvironmentResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /spaces/{space_id}
func (c *Client) GetSpace(ctx context.Context, params GetSpaceParams, options ...RequestOption) (GetSpaceRes, error) {
	res, err := c.sendGetSpace(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetSpace(ctx context.Context, params GetSpaceParams, requestOptions ...RequestOption) (res GetSpaceRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetSpaceOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
//
// GET /spaces
func (c *Client) GetSpaces(ctx context.Context, params GetSpacesParams, options ...RequestOption) (GetSpacesRes, error) {
	res, err := c.sendGetSpaces(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetSpaces(ctx context.Context, params GetSpacesParams, requestOptions ...RequestOption) (res GetSpacesRes, err error) {
	...
	h := uri.NewHeaderEncoder(r.Header)
	{
		...
		if err := h.EncodeParam(cfg, func(e uri.Encoder) error {
			if val, ok := params.XContentfulOrganization.Get(); ok {
				return e.EncodeValue(conv.StringToString(val))
			}
			return nil
		}); err != nil {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetSpacesOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
//
// GET /organizations/{organization_id}/teams
func (c *Client) GetTeams(ctx context.Context, params GetTeamsParams, options ...RequestOption) (GetTeamsRes, error) {
	res, err := c.sendGetTeams(ctx, params, options...)
	return res, err
}

func (c *Client) sendGetTeams(ctx context.Context, params GetTeamsParams, requestOptions ...RequestOption) (res GetTeamsRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, GetTeamsOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
//
// PUT /spaces/{space_id}/environments/{environment_id}/locales/{locale_id}
func (c *Client) PutLocale(ctx context.Context, request *LocaleData, params PutLocaleParams, options ...RequestOption) (PutLocaleRes, error) {
	res, err := c.sendPutLocale(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendPutLocale(ctx context.Context, request *LocaleData, params PutLocaleParams, requestOptions ...RequestOption) (res PutLocaleRes, err error) {
	...
	if err := encodePutLocaleRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, PutLocaleOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodePutLocaleResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// PUT /spaces/{space_id}/preview_environments/{preview_environment_id}
func (c *Client) PutPreviewEnvironment(ctx context.Context, request *PreviewEnvironmentData, params PutPreviewEnvironmentParams, options ...RequestOption) (PutPreviewEnvironmentRes, error) {
	res, err := c.sendPutPreviewEnvironment(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendPutPreviewEnvironment(ctx context.Context, request *PreviewEnvironmentData, params PutPreviewEnvironmentParams, requestOptions ...RequestOption) (res PutPreviewEnvironmentRes, err error) {
	...
	if err := encodePutPreviewEnvironmentRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, PutPreviewEnvironmentOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodePutPreviewEnvironmentResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// PUT /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
func (c *Client) UpdateAppAction(ctx context.Context, request *AppActionData, params UpdateAppActionParams, options ...RequestOption) (UpdateAppActionRes, error) {
	res, err := c.sendUpdateAppAction(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendUpdateAppAction(ctx context.Context, request *AppActionData, params UpdateAppActionParams, requestOptions ...RequestOption) (res UpdateAppActionRes, err error) {
	...
	if err := encodeUpdateAppActionRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, UpdateAppActionOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeUpdateAppActionResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
