...
type Invoker interface {
	...
	PutExtension(ctx context.Context, request *PutExtensionReq, params PutExtensionParams) (PutExtensionRes, error)
...
//
// PUT /spaces/{space_id}/environments/{environment_id}/extensions/{extension_id}
func (c *Client) PutExtension(ctx context.Context, request *PutExtensionReq, params PutExtensionParams) (PutExtensionRes, error) {
	res, err := c.sendPutExtension(ctx, request, params)
	return res, err
}

func (c *Client) sendPutExtension(ctx context.Context, request *PutExtensionReq, params PutExtensionParams) (res PutExtensionRes, err error) {
