...
type Invoker interface {
	...
	// Create a tag.
	//
	// POST /spaces/{space_id}/environments/{environment_id}/tags
	CreateTag(ctx context.Context, request *TagData, params CreateTagParams, options ...RequestOption) (CreateTagRes, error)
	...
	PutTag(ctx context.Context, request *TagData, params PutTagParams, options ...RequestOption) (PutTagRes, error)
...
//
// POST /spaces/{space_id}/environments/{environment_id}/tags
func (c *Client) CreateTag(ctx context.Context, request *TagData, params CreateTagParams, options ...RequestOption) (CreateTagRes, error) {
	res, err := c.sendCreateTag(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendCreateTag(ctx context.Context, request *TagData, params CreateTagParams, requestOptions ...RequestOption) (res CreateTagRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, CreateTagOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
//
// PUT /spaces/{space_id}/environments/{environment_id}/tags/{tag_id}
func (c *Client) PutTag(ctx context.Context, request *TagData, params PutTagParams, options ...RequestOption) (PutTagRes, error) {
	res, err := c.sendPutTag(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendPutTag(ctx context.Context, request *TagData, params PutTagParams, requestOptions ...RequestOption) (res PutTagRes, err error) {
