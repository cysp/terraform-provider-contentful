...
func (c *Client) sendDeleteExtension(ctx context.Context, params DeleteExtensionParams) (res DeleteExtensionRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, "DeleteExtension", r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendGetExtension(ctx context.Context, params GetExtensionParams) (res GetExtensionRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, "GetExtension", r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendPutExtension(ctx context.Context, request *PutExtensionReq, params PutExtensionParams) (res PutExtensionRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityAccessToken(ctx, "PutExtension", r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
