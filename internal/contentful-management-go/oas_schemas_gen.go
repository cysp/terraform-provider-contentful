...
// GetSettings returns the value of Settings.
func (s *EditorInterfaceEditorsItem) GetSettings() jx.Raw {
	return s.Settings
}
...
// SetSettings sets the value of Settings.
func (s *EditorInterfaceEditorsItem) SetSettings(val jx.Raw) {
	s.Settings = val
}
...
// GetSettings returns the value of Settings.
func (s *PutEditorInterfaceReqEditorsItem) GetSettings() jx.Raw {
	return s.Settings
}
...
// SetSettings sets the value of Settings.
func (s *PutEditorInterfaceReqEditorsItem) SetSettings(val jx.Raw) {
	s.Settings = val
}
