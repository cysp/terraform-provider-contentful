...
// Ref: #/EnvironmentAliasRequest
type EnvironmentAliasRequest struct {
	Environment EnvironmentLink `json:"environment"`
}

// GetEnvironment returns the value of Environment.
func (s *EnvironmentAliasRequest) GetEnvironment() EnvironmentLink {
	return s.Environment
}

// SetEnvironment sets the value of Environment.
func (s *EnvironmentAliasRequest) SetEnvironment(val EnvironmentLink) {
	s.Environment = val
}
...
const (
	EnvironmentAliasSysTypeEnvironmentAlias EnvironmentAliasSysType = "Environment Alias"
)
