...
type GetEntriesParams struct {
	...
	Select OptString `json:",omitempty,omitzero"`
	// Maximum number of entries to return.
	Limit OptInt `json:",omitempty,omitzero"`
	// Number of entries to skip.
	Skip OptInt `json:",omitempty,omitzero"`
	// Order entries by field.
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				...
				if err := func() error {
					...
					paramsDotSelectVal = c
					return nil
				}(); err != nil {
					return err
				}
				params.Select.SetTo(paramsDotSelectVal)
				return nil
			}); err != nil {
				return err
			}
