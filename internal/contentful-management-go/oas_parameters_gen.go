...
func unpackGetTagsParams(packed middleware.Parameters) (params GetTagsParams) {
	{
		key := middleware.ParameterKey{
			Name: "space_id",
			In:   "path",
...
func decodeGetTagsParams(args [2]string, argsEscaped bool, r *http.Request) (params GetTagsParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	// Decode path: space_id.
	if err := func() error {
		param := args[0]
