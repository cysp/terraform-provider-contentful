							...
							case '/': // Prefix: "/"
								...
								case 'a': // Prefix: "actions"
									...
									if len(elem) == 0 {
										switch r.Method {
										case "GET":
											s.handleGetAppActionsRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										case "POST":
											s.handleCreateAppActionRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										default:
									...
									case '/': // Prefix: "/"
										...
										if len(elem) == 0 {
											...
											switch r.Method {
											case "DELETE":
												s.handleDeleteAppActionRequest([3]string{
													args[0],
													args[1],
													args[2],
												}, elemIsEscaped, w, r)
											case "GET":
												s.handleGetAppActionRequest([3]string{
													args[0],
													args[1],
													args[2],
												}, elemIsEscaped, w, r)
											case "PUT":
												s.handleUpdateAppActionRequest([3]string{
													args[0],
													args[1],
													args[2],
												}, elemIsEscaped, w, r)
								...
								case 'e': // Prefix: "event_subscription"

									if l := len("event_subscription"); len(elem) >= l && elem[0:l] == "event_subscription" {
										elem = elem[l:]
									} else {
										break
									}
									...
									if len(elem) == 0 {
										...
										switch r.Method {
										case "DELETE":
											s.handleDeleteAppEventSubscriptionRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										case "GET":
											s.handleGetAppEventSubscriptionRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										case "PUT":
											s.handlePutAppEventSubscriptionRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										default:
								...
								case 'k': // Prefix: "keys"
									...
									if len(elem) == 0 {
										switch r.Method {
										case "GET":
											s.handleGetAppKeysRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										case "POST":
											s.handleCreateAppKeyRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										default:
									...
									case '/': // Prefix: "/"
										...
										if len(elem) == 0 {
											...
											switch r.Method {
											case "DELETE":
												s.handleDeleteAppKeyRequest([3]string{
													args[0],
													args[1],
													args[2],
												}, elemIsEscaped, w, r)
											case "GET":
												s.handleGetAppKeyRequest([3]string{
													args[0],
													args[1],
													args[2],
												}, elemIsEscaped, w, r)
											...
											case 'l': // Prefix: "l"
												...
												case 'o': // Prefix: "ocales"
													...
													if len(elem) == 0 {
														...
														case "POST":
															s.handleCreateLocaleRequest([2]string{
																args[0],
																args[1],
															}, elemIsEscaped, w, r)
														default:
													...
													case '/': // Prefix: "/"
														...
														if len(elem) == 0 {
															...
															switch r.Method {
															case "DELETE":
																s.handleDeleteLocaleRequest([3]string{
																	args[0],
																	args[1],
																	args[2],
																}, elemIsEscaped, w, r)
															...
															case "PUT":
																s.handlePutLocaleRequest([3]string{
																	args[0],
																	args[1],
																	args[2],
																}, elemIsEscaped, w, r)
							...
							case '/': // Prefix: "/"
								...
								case 'a': // Prefix: "actions"
									...
									if len(elem) == 0 {
										switch method {
										case "GET":
											r.name = GetAppActionsOperation
											r.summary = ""
											r.operationID = "getAppActions"
											r.operationGroup = ""
											r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/actions"
											r.args = args
											r.count = 2
											return r, true
										case "POST":
											r.name = CreateAppActionOperation
											r.summary = ""
											r.operationID = "createAppAction"
											r.operationGroup = ""
											r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/actions"
											r.args = args
											r.count = 2
									...
									case '/': // Prefix: "/"
										...
										if len(elem) == 0 {
											...
											switch method {
											case "DELETE":
												r.name = DeleteAppActionOperation
												r.summary = ""
												r.operationID = "deleteAppAction"
												r.operationGroup = ""
												r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}"
												r.args = args
												r.count = 3
												return r, true
											case "GET":
												r.name = GetAppActionOperation
												r.summary = ""
												r.operationID = "getAppAction"
												r.operationGroup = ""
												r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}"
												r.args = args
												r.count = 3
												return r, true
											case "PUT":
												r.name = UpdateAppActionOperation
												r.summary = ""
												r.operationID = "updateAppAction"
												r.operationGroup = ""
												r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}"
												r.args = args
												r.count = 3
								...
								case 'e': // Prefix: "event_subscription"
									...
									if len(elem) == 0 {
										...
										switch method {
										case "DELETE":
											r.name = DeleteAppEventSubscriptionOperation
											r.summary = "Delete an app event subscription"
											r.operationID = "deleteAppEventSubscription"
											r.operationGroup = ""
											r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/event_subscription"
											r.args = args
											r.count = 2
											return r, true
										case "GET":
											r.name = GetAppEventSubscriptionOperation
											r.summary = "Get one app event subscription"
											r.operationID = "getAppEventSubscription"
											r.operationGroup = ""
											r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/event_subscription"
											r.args = args
											r.count = 2
											return r, true
										case "PUT":
											r.name = PutAppEventSubscriptionOperation
											r.summary = "Create or update an app event subscription"
											r.operationID = "putAppEventSubscription"
											r.operationGroup = ""
											r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/event_subscription"
											r.args = args
											r.count = 2
								...
								case 'k': // Prefix: "keys"
									...
									if len(elem) == 0 {
										...
										case "GET":
											...
											return r, true
										case "POST":
											r.name = CreateAppKeyOperation
											r.summary = "Create an app key"
											r.operationID = "createAppKey"
											r.operationGroup = ""
											r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/keys"
											r.args = args
											r.count = 2
									...
									case '/': // Prefix: "/"
										...
										if len(elem) == 0 {
											...
											switch method {
											case "DELETE":
												r.name = DeleteAppKeyOperation
												r.summary = "Delete an app key"
												r.operationID = "deleteAppKey"
												r.operationGroup = ""
												r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/keys/{key_kid}"
												r.args = args
												r.count = 3
												return r, true
											case "GET":
												r.name = GetAppKeyOperation
												r.summary = "Get one app key"
												r.operationID = "getAppKey"
												r.operationGroup = ""
												r.pathPattern = "/organizations/{organization_id}/app_definitions/{app_definition_id}/keys/{key_kid}"
												r.args = args
												r.count = 3
												...
												case 'o': // Prefix: "ocales"
													...
													if len(elem) == 0 {
														...
														case "GET":
															...
															return r, true
														case "POST":
															r.name = CreateLocaleOperation
															r.summary = "Create a locale"
															r.operationID = "createLocale"
															r.operationGroup = ""
															r.pathPattern = "/spaces/{space_id}/environments/{environment_id}/locales"
															r.args = args
															r.count = 2
													...
													case '/': // Prefix: "/"
														...
														if len(elem) == 0 {
															...
															switch method {
															case "DELETE":
																r.name = DeleteLocaleOperation
																r.summary = "Delete a locale"
																r.operationID = "deleteLocale"
																r.operationGroup = ""
															...
															case "GET":
																...
																return r, true
															case "PUT":
																r.name = PutLocaleOperation
																r.summary = "Update a locale"
																r.operationID = "putLocale"
																r.operationGroup = ""
																r.pathPattern = "/spaces/{space_id}/environments/{environment_id}/locales/{locale_id}"
																r.args = args
																r.count = 3
