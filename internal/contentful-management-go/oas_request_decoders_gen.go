...
func (s *Server) decodeCreateAppKeyRequest(r *http.Request) (
...
func (s *Server) decodeCreateLocaleRequest(r *http.Request) (
	req *LocaleData,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeCreateTeamSpaceMembershipRequest(r *http.Request) (
	...
	case ct == "application/vnd.contentful.management.v1+json":
		...
		var request TeamSpaceMembershipData
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePatchTaxonomyConceptRequest(r *http.Request) (
	req TaxonomyPatch,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodePatchTaxonomyConceptSchemeRequest(r *http.Request) (
	req TaxonomyPatch,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodePutAppEventSubscriptionRequest(r *http.Request) (
	req *AppEventSubscriptionData,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/vnd.contentful.management.v1+json":
		...
		var request AppEventSubscriptionData
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePutLivePreviewVariablesRequest(r *http.Request) (
	req *LivePreviewVariablesData,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/vnd.contentful.management.v1+json":
		...
		var request LivePreviewVariablesData
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePutLocaleRequest(r *http.Request) (
	req *LocaleData,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodePutPreviewEnvironmentRequest(r *http.Request) (
	req *PreviewEnvironmentData,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodePutTagRequest(r *http.Request) (
	req *TagRequest,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodePutTaxonomyConceptRequest(r *http.Request) (
	...
	case ct == "application/vnd.contentful.management.v1+json":
		...
		var request TaxonomyConceptRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePutTaxonomyConceptSchemeRequest(r *http.Request) (
	...
	case ct == "application/vnd.contentful.management.v1+json":
		...
		var request TaxonomyConceptSchemeRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePutTeamSpaceMembershipRequest(r *http.Request) (
	req *TeamSpaceMembershipData,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodePutWebhookSigningSecretRequest(r *http.Request) (
	...
	case ct == "application/vnd.contentful.management.v1+json":
		...
		var request WebhookSigningSecretRequestData
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateAppActionRequest(r *http.Request) (
	req *AppActionData,
	rawBody []byte,
	close func() error,
	rerr error,
