...
type Handler interface {
	...
	CreateTag(ctx context.Context, req *TagData, params CreateTagParams) (CreateTagRes, error)
	...
	PutTag(ctx context.Context, req *TagData, params PutTagParams) (PutTagRes, error)
