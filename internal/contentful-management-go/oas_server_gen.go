...
type Handler interface {
	...
	CreateOrUpdateEnvironmentAlias(ctx context.Context, req *EnvironmentAliasRequest, params CreateOrUpdateEnvironmentAliasParams) (CreateOrUpdateEnvironmentAliasRes, error)
