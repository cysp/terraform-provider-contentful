...
// handleCreateAppActionRequest handles createAppAction operation.
//
// POST /organizations/{organization_id}/app_definitions/{app_definition_id}/actions
func (s *Server) handleCreateAppActionRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, CreateAppActionOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeCreateAppActionParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodeCreateAppActionRequest(r)
	if err != nil {
	...
	var response CreateAppActionRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    CreateAppActionOperation,
			OperationSummary: "",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackCreateAppActionParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.CreateAppAction(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeCreateAppActionResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleCreateAppKeyRequest handles createAppKey operation.
//
// Create an app key.
//
// POST /organizations/{organization_id}/app_definitions/{app_definition_id}/keys
func (s *Server) handleCreateAppKeyRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, CreateAppKeyOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeCreateAppKeyParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodeCreateAppKeyRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response CreateAppKeyRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    CreateAppKeyOperation,
			OperationSummary: "Create an app key",
		...
		type (
			Request  = *AppKeyRequestData
			Params   = CreateAppKeyParams
			Response = CreateAppKeyRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackCreateAppKeyParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.CreateAppKey(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeCreateAppKeyResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleCreateLocaleRequest handles createLocale operation.
//
// Create a locale.
//
// POST /spaces/{space_id}/environments/{environment_id}/locales
func (s *Server) handleCreateLocaleRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, CreateLocaleOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeCreateLocaleParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodeCreateLocaleRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response CreateLocaleRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    CreateLocaleOperation,
			OperationSummary: "Create a locale",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackCreateLocaleParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.CreateLocale(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeCreateLocaleResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleCreatePreviewEnvironmentRequest handles createPreviewEnvironment operation.
//
// Create a content preview platform.
//
// POST /spaces/{space_id}/preview_environments
func (s *Server) handleCreatePreviewEnvironmentRequest(args [1]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: CreatePreviewEnvironmentOperation,
			ID:   "createPreviewEnvironment",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, CreatePreviewEnvironmentOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeCreatePreviewEnvironmentParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodeCreatePreviewEnvironmentRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response CreatePreviewEnvironmentRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    CreatePreviewEnvironmentOperation,
			OperationSummary: "Create a content preview platform",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackCreatePreviewEnvironmentParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.CreatePreviewEnvironment(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeCreatePreviewEnvironmentResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleDeleteAppActionRequest handles deleteAppAction operation.
//
// DELETE /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
func (s *Server) handleDeleteAppActionRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteAppActionOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeleteAppActionParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeleteAppActionRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeleteAppActionOperation,
			OperationSummary: "",
			OperationID:      "deleteAppAction",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = struct{}
			Params   = DeleteAppActionParams
			Response = DeleteAppActionRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackDeleteAppActionParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeleteAppAction(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeleteAppActionResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleDeleteAppEventSubscriptionRequest handles deleteAppEventSubscription operation.
//
...
func (s *Server) handleDeleteAppEventSubscriptionRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: DeleteAppEventSubscriptionOperation,
			ID:   "deleteAppEventSubscription",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteAppEventSubscriptionOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeleteAppEventSubscriptionParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeleteAppEventSubscriptionRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeleteAppEventSubscriptionOperation,
			OperationSummary: "Delete an app event subscription",
			OperationID:      "deleteAppEventSubscription",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = struct{}
			Params   = DeleteAppEventSubscriptionParams
			Response = DeleteAppEventSubscriptionRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackDeleteAppEventSubscriptionParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeleteAppEventSubscription(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeleteAppEventSubscriptionResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleDeleteAppKeyRequest handles deleteAppKey operation.
//
// Delete an app key.
//
// DELETE /organizations/{organization_id}/app_definitions/{app_definition_id}/keys/{key_kid}
func (s *Server) handleDeleteAppKeyRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteAppKeyOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeleteAppKeyParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeleteAppKeyRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeleteAppKeyOperation,
			OperationSummary: "Delete an app key",
		...
		type (
			Request  = struct{}
			Params   = DeleteAppKeyParams
			Response = DeleteAppKeyRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackDeleteAppKeyParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeleteAppKey(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeleteAppKeyResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleDeleteLivePreviewVariablesRequest handles deleteLivePreviewVariables operation.
//
// Delete live preview variables.
//
// DELETE /spaces/{space_id}/environments/{environment_id}/live_preview/variables
func (s *Server) handleDeleteLivePreviewVariablesRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: DeleteLivePreviewVariablesOperation,
			ID:   "deleteLivePreviewVariables",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteLivePreviewVariablesOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeleteLivePreviewVariablesParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeleteLivePreviewVariablesRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeleteLivePreviewVariablesOperation,
			OperationSummary: "Delete live preview variables",
			OperationID:      "deleteLivePreviewVariables",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = struct{}
			Params   = DeleteLivePreviewVariablesParams
			Response = DeleteLivePreviewVariablesRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackDeleteLivePreviewVariablesParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeleteLivePreviewVariables(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeleteLivePreviewVariablesResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleDeleteLocaleRequest handles deleteLocale operation.
//
// Delete a locale.
//
// DELETE /spaces/{space_id}/environments/{environment_id}/locales/{locale_id}
func (s *Server) handleDeleteLocaleRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteLocaleOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeleteLocaleParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeleteLocaleRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeleteLocaleOperation,
			OperationSummary: "Delete a locale",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackDeleteLocaleParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeleteLocale(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeleteLocaleResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleDeletePreviewEnvironmentRequest handles deletePreviewEnvironment operation.
//
// Delete a content preview platform.
//
// DELETE /spaces/{space_id}/preview_environments/{preview_environment_id}
func (s *Server) handleDeletePreviewEnvironmentRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: DeletePreviewEnvironmentOperation,
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeletePreviewEnvironmentOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeletePreviewEnvironmentParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeletePreviewEnvironmentRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeletePreviewEnvironmentOperation,
			OperationSummary: "Delete a content preview platform",
		...
		type (
			Request  = struct{}
			Params   = DeletePreviewEnvironmentParams
			Response = DeletePreviewEnvironmentRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackDeletePreviewEnvironmentParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeletePreviewEnvironment(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeletePreviewEnvironmentResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
func (s *Server) handleDeleteTagRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteTagOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
...
// handleDeleteTaxonomyConceptRequest handles deleteTaxonomyConcept operation.
//
// Delete a taxonomy concept.
//
// DELETE /organizations/{organization_id}/taxonomy/concepts/{taxonomy_concept_id}
func (s *Server) handleDeleteTaxonomyConceptRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: DeleteTaxonomyConceptOperation,
			ID:   "deleteTaxonomyConcept",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteTaxonomyConceptOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeleteTaxonomyConceptParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeleteTaxonomyConceptRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeleteTaxonomyConceptOperation,
			OperationSummary: "Delete a taxonomy concept",
			OperationID:      "deleteTaxonomyConcept",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
				...
				{
					Name: "taxonomy_concept_id",
					In:   "path",
				}: params.TaxonomyConceptID,
			},
			Raw: r,
		}
		...
		type (
			Request  = struct{}
			Params   = DeleteTaxonomyConceptParams
			Response = DeleteTaxonomyConceptRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackDeleteTaxonomyConceptParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeleteTaxonomyConcept(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeleteTaxonomyConceptResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleDeleteTaxonomyConceptSchemeRequest handles deleteTaxonomyConceptScheme operation.
//
// Delete a taxonomy concept scheme.
//
// DELETE /organizations/{organization_id}/taxonomy/concept-schemes/{taxonomy_concept_scheme_id}
func (s *Server) handleDeleteTaxonomyConceptSchemeRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: DeleteTaxonomyConceptSchemeOperation,
			ID:   "deleteTaxonomyConceptScheme",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteTaxonomyConceptSchemeOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeleteTaxonomyConceptSchemeParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeleteTaxonomyConceptSchemeRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeleteTaxonomyConceptSchemeOperation,
			OperationSummary: "Delete a taxonomy concept scheme",
			OperationID:      "deleteTaxonomyConceptScheme",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
				...
				{
					Name: "taxonomy_concept_scheme_id",
					In:   "path",
				}: params.TaxonomyConceptSchemeID,
			},
			Raw: r,
		}
		...
		type (
			Request  = struct{}
			Params   = DeleteTaxonomyConceptSchemeParams
			Response = DeleteTaxonomyConceptSchemeRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackDeleteTaxonomyConceptSchemeParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeleteTaxonomyConceptScheme(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeleteTaxonomyConceptSchemeResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleDeleteWebhookSigningSecretRequest handles deleteWebhookSigningSecret operation.
//
// Delete a webhook signing secret.
//
// DELETE /spaces/{space_id}/webhook_settings/signing_secret
func (s *Server) handleDeleteWebhookSigningSecretRequest(args [1]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: DeleteWebhookSigningSecretOperation,
			ID:   "deleteWebhookSigningSecret",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, DeleteWebhookSigningSecretOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeDeleteWebhookSigningSecretParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response DeleteWebhookSigningSecretRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    DeleteWebhookSigningSecretOperation,
			OperationSummary: "Delete a webhook signing secret",
			OperationID:      "deleteWebhookSigningSecret",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = struct{}
			Params   = DeleteWebhookSigningSecretParams
			Response = DeleteWebhookSigningSecretRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackDeleteWebhookSigningSecretParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.DeleteWebhookSigningSecret(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeDeleteWebhookSigningSecretResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetAppActionRequest handles getAppAction operation.
//
// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
func (s *Server) handleGetAppActionRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetAppActionOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetAppActionParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetAppActionRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetAppActionOperation,
			OperationSummary: "",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackGetAppActionParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetAppAction(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetAppActionResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetAppActionsRequest handles getAppActions operation.
//
// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/actions
func (s *Server) handleGetAppActionsRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetAppActionsOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetAppActionsParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetAppActionsRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetAppActionsOperation,
			OperationSummary: "",
		...
		type (
			Request  = struct{}
			Params   = GetAppActionsParams
			Response = GetAppActionsRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetAppActionsParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetAppActions(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetAppActionsResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetAppEventSubscriptionRequest handles getAppEventSubscription operation.
//
// Get one app event subscription.
//
// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/event_subscription
func (s *Server) handleGetAppEventSubscriptionRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: GetAppEventSubscriptionOperation,
			ID:   "getAppEventSubscription",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetAppEventSubscriptionOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetAppEventSubscriptionParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetAppEventSubscriptionRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetAppEventSubscriptionOperation,
			OperationSummary: "Get one app event subscription",
		...
		type (
			Request  = struct{}
			Params   = GetAppEventSubscriptionParams
			Response = GetAppEventSubscriptionRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetAppEventSubscriptionParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetAppEventSubscription(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetAppEventSubscriptionResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetAppKeyRequest handles getAppKey operation.
//
// Get one app key.
//
// GET /organizations/{organization_id}/app_definitions/{app_definition_id}/keys/{key_kid}
func (s *Server) handleGetAppKeyRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetAppKeyOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetAppKeyParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetAppKeyRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetAppKeyOperation,
			OperationSummary: "Get one app key",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackGetAppKeyParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetAppKey(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetAppKeyResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
func (s *Server) handleGetAppKeysRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetAppKeysOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetAppKeysParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	if m := s.cfg.Middleware; m != nil {
		...
		type (
			Request  = struct{}
			Params   = GetAppKeysParams
			Response = GetAppKeysRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetAppKeysParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetAppKeys(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetAppKeysResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetEnvironmentAliasesRequest handles getEnvironmentAliases operation.
//
// Read EnvironmentAlias collection.
//
// GET /spaces/{space_id}/environment_aliases
func (s *Server) handleGetEnvironmentAliasesRequest(args [1]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: GetEnvironmentAliasesOperation,
			ID:   "getEnvironmentAliases",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetEnvironmentAliasesOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetEnvironmentAliasesParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetEnvironmentAliasesRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetEnvironmentAliasesOperation,
			OperationSummary: "Read EnvironmentAlias collection",
			OperationID:      "getEnvironmentAliases",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = struct{}
			Params   = GetEnvironmentAliasesParams
			Response = GetEnvironmentAliasesRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetEnvironmentAliasesParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetEnvironmentAliases(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetEnvironmentAliasesResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
func (s *Server) handleGetEnvironmentsRequest(args [1]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetEnvironmentsOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetEnvironmentsParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			...
			OperationSummary: "Read Environment collection",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackGetEnvironmentsParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetEnvironments(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetEnvironmentsResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetLivePreviewVariablesRequest handles getLivePreviewVariables operation.
//
// Get live preview variables.
//
// GET /spaces/{space_id}/environments/{environment_id}/live_preview/variables
func (s *Server) handleGetLivePreviewVariablesRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: GetLivePreviewVariablesOperation,
			ID:   "getLivePreviewVariables",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetLivePreviewVariablesOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetLivePreviewVariablesParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetLivePreviewVariablesRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetLivePreviewVariablesOperation,
			OperationSummary: "Get live preview variables",
			OperationID:      "getLivePreviewVariables",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = struct{}
			Params   = GetLivePreviewVariablesParams
			Response = GetLivePreviewVariablesRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetLivePreviewVariablesParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetLivePreviewVariables(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetLivePreviewVariablesResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetLocaleRequest handles getLocale operation.
//
// Read Locale.
//
// GET /spaces/{space_id}/environments/{environment_id}/locales/{locale_id}
func (s *Server) handleGetLocaleRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetLocaleOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetLocaleParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetLocaleRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetLocaleOperation,
			OperationSummary: "Read Locale",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackGetLocaleParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetLocale(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetLocaleResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetLocalesRequest handles getLocales operation.
//
// Read Locale collection.
//
// GET /spaces/{space_id}/environments/{environment_id}/locales
func (s *Server) handleGetLocalesRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetLocalesOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetLocalesParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetLocalesRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetLocalesOperation,
			OperationSummary: "Read Locale collection",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackGetLocalesParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetLocales(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetLocalesResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetPreviewEnvironmentRequest handles getPreviewEnvironment operation.
//
// Get a content preview platform.
//
// GET /spaces/{space_id}/preview_environments/{preview_environment_id}
func (s *Server) handleGetPreviewEnvironmentRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: GetPreviewEnvironmentOperation,
			ID:   "getPreviewEnvironment",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetPreviewEnvironmentOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetPreviewEnvironmentParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetPreviewEnvironmentRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetPreviewEnvironmentOperation,
			OperationSummary: "Get a content preview platform",
		...
		type (
			Request  = struct{}
			Params   = GetPreviewEnvironmentParams
			Response = GetPreviewEnvironmentRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetPreviewEnvironmentParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetPreviewEnvironment(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetPreviewEnvironmentResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
//
// GET /spaces/{space_id}
func (s *Server) handleGetSpaceRequest(args [1]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetSpaceOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetSpaceParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetSpaceRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetSpaceOperation,
			OperationSummary: "Read Space",
		...
		response, err = middleware.HookMiddleware[
			...
			m,
			mreq,
			unpackGetSpaceParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetSpace(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetSpaceResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
//
// GET /spaces
func (s *Server) handleGetSpacesRequest(args [0]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetSpacesOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	var response GetSpacesRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetSpacesOperation,
			OperationSummary: "Read Space collection",
			...
			Params: middleware.Parameters{
				...
				}: params.Limit,
				{
					...
					In:   "header",
				}: params.XContentfulOrganization,
			},
			Raw: r,
		}
	...
	if err := encodeGetSpacesResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
func (s *Server) handleGetTagRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetTagOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			...
			OperationSummary: "Get a single tag",
			OperationID:      "getTag",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
...
// handleGetTaxonomyConceptRequest handles getTaxonomyConcept operation.
//
// Get a taxonomy concept.
//
// GET /organizations/{organization_id}/taxonomy/concepts/{taxonomy_concept_id}
func (s *Server) handleGetTaxonomyConceptRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: GetTaxonomyConceptOperation,
			ID:   "getTaxonomyConcept",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetTaxonomyConceptOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetTaxonomyConceptParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetTaxonomyConceptRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetTaxonomyConceptOperation,
			OperationSummary: "Get a taxonomy concept",
			OperationID:      "getTaxonomyConcept",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = struct{}
			Params   = GetTaxonomyConceptParams
			Response = GetTaxonomyConceptRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetTaxonomyConceptParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetTaxonomyConcept(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetTaxonomyConceptResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetTaxonomyConceptSchemeRequest handles getTaxonomyConceptScheme operation.
//
// Get a taxonomy concept scheme.
//
// GET /organizations/{organization_id}/taxonomy/concept-schemes/{taxonomy_concept_scheme_id}
func (s *Server) handleGetTaxonomyConceptSchemeRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: GetTaxonomyConceptSchemeOperation,
			ID:   "getTaxonomyConceptScheme",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetTaxonomyConceptSchemeOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetTaxonomyConceptSchemeParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetTaxonomyConceptSchemeRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetTaxonomyConceptSchemeOperation,
			OperationSummary: "Get a taxonomy concept scheme",
			OperationID:      "getTaxonomyConceptScheme",
			Body:             nil,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = struct{}
			Params   = GetTaxonomyConceptSchemeParams
			Response = GetTaxonomyConceptSchemeRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetTaxonomyConceptSchemeParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetTaxonomyConceptScheme(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetTaxonomyConceptSchemeResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetTeamsRequest handles getTeams operation.
//
// Get a collection of teams.
//
// GET /organizations/{organization_id}/teams
func (s *Server) handleGetTeamsRequest(args [1]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetTeamsOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	var response GetTeamsRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetTeamsOperation,
			OperationSummary: "Get a collection of teams",
	...
	if err := encodeGetTeamsResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleGetWebhookSigningSecretRequest handles getWebhookSigningSecret operation.
//
// Get one webhook signing secret.
//
// GET /spaces/{space_id}/webhook_settings/signing_secret
func (s *Server) handleGetWebhookSigningSecretRequest(args [1]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: GetWebhookSigningSecretOperation,
			ID:   "getWebhookSigningSecret",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, GetWebhookSigningSecretOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeGetWebhookSigningSecretParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response GetWebhookSigningSecretRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    GetWebhookSigningSecretOperation,
			OperationSummary: "Get one webhook signing secret",
		...
		type (
			Request  = struct{}
			Params   = GetWebhookSigningSecretParams
			Response = GetWebhookSigningSecretRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackGetWebhookSigningSecretParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.GetWebhookSigningSecret(ctx, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeGetWebhookSigningSecretResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePatchTaxonomyConceptRequest handles patchTaxonomyConcept operation.
//
// Update a taxonomy concept.
//
// PATCH /organizations/{organization_id}/taxonomy/concepts/{taxonomy_concept_id}
func (s *Server) handlePatchTaxonomyConceptRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: PatchTaxonomyConceptOperation,
			ID:   "patchTaxonomyConcept",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PatchTaxonomyConceptOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePatchTaxonomyConceptParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePatchTaxonomyConceptRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PatchTaxonomyConceptRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PatchTaxonomyConceptOperation,
			OperationSummary: "Update a taxonomy concept",
			OperationID:      "patchTaxonomyConcept",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = TaxonomyPatch
			Params   = PatchTaxonomyConceptParams
			Response = PatchTaxonomyConceptRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPatchTaxonomyConceptParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PatchTaxonomyConcept(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePatchTaxonomyConceptResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePatchTaxonomyConceptSchemeRequest handles patchTaxonomyConceptScheme operation.
//
// Update a taxonomy concept scheme.
//
// PATCH /organizations/{organization_id}/taxonomy/concept-schemes/{taxonomy_concept_scheme_id}
func (s *Server) handlePatchTaxonomyConceptSchemeRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: PatchTaxonomyConceptSchemeOperation,
			ID:   "patchTaxonomyConceptScheme",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PatchTaxonomyConceptSchemeOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePatchTaxonomyConceptSchemeParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePatchTaxonomyConceptSchemeRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PatchTaxonomyConceptSchemeRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PatchTaxonomyConceptSchemeOperation,
			OperationSummary: "Update a taxonomy concept scheme",
			OperationID:      "patchTaxonomyConceptScheme",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = TaxonomyPatch
			Params   = PatchTaxonomyConceptSchemeParams
			Response = PatchTaxonomyConceptSchemeRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPatchTaxonomyConceptSchemeParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PatchTaxonomyConceptScheme(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePatchTaxonomyConceptSchemeResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePutAppEventSubscriptionRequest handles putAppEventSubscription operation.
//
...
func (s *Server) handlePutAppEventSubscriptionRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: PutAppEventSubscriptionOperation,
			ID:   "putAppEventSubscription",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PutAppEventSubscriptionOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePutAppEventSubscriptionParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePutAppEventSubscriptionRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PutAppEventSubscriptionRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PutAppEventSubscriptionOperation,
			OperationSummary: "Create or update an app event subscription",
			OperationID:      "putAppEventSubscription",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = *AppEventSubscriptionData
			Params   = PutAppEventSubscriptionParams
			Response = PutAppEventSubscriptionRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPutAppEventSubscriptionParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PutAppEventSubscription(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePutAppEventSubscriptionResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePutLivePreviewVariablesRequest handles putLivePreviewVariables operation.
//
// Replace live preview variables.
//
// PUT /spaces/{space_id}/environments/{environment_id}/live_preview/variables
func (s *Server) handlePutLivePreviewVariablesRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: PutLivePreviewVariablesOperation,
			ID:   "putLivePreviewVariables",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PutLivePreviewVariablesOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePutLivePreviewVariablesParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePutLivePreviewVariablesRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PutLivePreviewVariablesRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PutLivePreviewVariablesOperation,
			OperationSummary: "Replace live preview variables",
			OperationID:      "putLivePreviewVariables",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = *LivePreviewVariablesData
			Params   = PutLivePreviewVariablesParams
			Response = PutLivePreviewVariablesRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPutLivePreviewVariablesParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PutLivePreviewVariables(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePutLivePreviewVariablesResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePutLocaleRequest handles putLocale operation.
//
// Update a locale.
//
// PUT /spaces/{space_id}/environments/{environment_id}/locales/{locale_id}
func (s *Server) handlePutLocaleRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PutLocaleOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePutLocaleParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePutLocaleRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PutLocaleRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PutLocaleOperation,
			OperationSummary: "Update a locale",
		...
		type (
			Request  = *LocaleData
			Params   = PutLocaleParams
			Response = PutLocaleRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPutLocaleParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PutLocale(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePutLocaleResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePutPreviewEnvironmentRequest handles putPreviewEnvironment operation.
//
...
func (s *Server) handlePutPreviewEnvironmentRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: PutPreviewEnvironmentOperation,
			ID:   "putPreviewEnvironment",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PutPreviewEnvironmentOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePutPreviewEnvironmentParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePutPreviewEnvironmentRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PutPreviewEnvironmentRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PutPreviewEnvironmentOperation,
			OperationSummary: "Create or update a content preview platform with a selected ID",
			OperationID:      "putPreviewEnvironment",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = *PreviewEnvironmentData
			Params   = PutPreviewEnvironmentParams
			Response = PutPreviewEnvironmentRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPutPreviewEnvironmentParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PutPreviewEnvironment(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePutPreviewEnvironmentResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePutTagRequest handles putTag operation.
//
// Create or update a tag.
//
// PUT /spaces/{space_id}/environments/{environment_id}/tags/{tag_id}
func (s *Server) handlePutTagRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PutTagOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePutTagParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePutTagRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PutTagRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PutTagOperation,
			OperationSummary: "Create or update a tag",
			OperationID:      "putTag",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				...
				}: params.XContentfulVersion,
				{
					...
					In:   "header",
				}: params.XContentfulTagVisibility,
			},
			Raw: r,
		}
		...
		response, err = middleware.HookMiddleware[
			...
			unpackPutTagParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PutTag(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePutTagResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePutTaxonomyConceptRequest handles putTaxonomyConcept operation.
//
...
func (s *Server) handlePutTaxonomyConceptRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: PutTaxonomyConceptOperation,
			ID:   "putTaxonomyConcept",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PutTaxonomyConceptOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePutTaxonomyConceptParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePutTaxonomyConceptRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PutTaxonomyConceptRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PutTaxonomyConceptOperation,
			OperationSummary: "Create a taxonomy concept with a caller-defined ID",
			OperationID:      "putTaxonomyConcept",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = *TaxonomyConceptRequest
			Params   = PutTaxonomyConceptParams
			Response = PutTaxonomyConceptRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPutTaxonomyConceptParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PutTaxonomyConcept(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePutTaxonomyConceptResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePutTaxonomyConceptSchemeRequest handles putTaxonomyConceptScheme operation.
//
...
func (s *Server) handlePutTaxonomyConceptSchemeRequest(args [2]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: PutTaxonomyConceptSchemeOperation,
			ID:   "putTaxonomyConceptScheme",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PutTaxonomyConceptSchemeOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePutTaxonomyConceptSchemeParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePutTaxonomyConceptSchemeRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PutTaxonomyConceptSchemeRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PutTaxonomyConceptSchemeOperation,
			OperationSummary: "Create a taxonomy concept scheme with a caller-defined ID",
			OperationID:      "putTaxonomyConceptScheme",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = *TaxonomyConceptSchemeRequest
			Params   = PutTaxonomyConceptSchemeParams
			Response = PutTaxonomyConceptSchemeRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPutTaxonomyConceptSchemeParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PutTaxonomyConceptScheme(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePutTaxonomyConceptSchemeResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handlePutWebhookSigningSecretRequest handles putWebhookSigningSecret operation.
//
// Create or update a webhook signing secret.
//
// PUT /spaces/{space_id}/webhook_settings/signing_secret
func (s *Server) handlePutWebhookSigningSecretRequest(args [1]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	var (
		err          error
		opErrContext = ogenerrors.OperationContext{
			Name: PutWebhookSigningSecretOperation,
			ID:   "putWebhookSigningSecret",
		}
	)
	{
		type bitset = [1]uint8
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, PutWebhookSigningSecretOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodePutWebhookSigningSecretParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodePutWebhookSigningSecretRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response PutWebhookSigningSecretRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    PutWebhookSigningSecretOperation,
			OperationSummary: "Create or update a webhook signing secret",
			OperationID:      "putWebhookSigningSecret",
			Body:             request,
			RawBody:          rawBody,
			Params: middleware.Parameters{
				{
		...
		type (
			Request  = *WebhookSigningSecretRequestData
			Params   = PutWebhookSigningSecretParams
			Response = PutWebhookSigningSecretRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackPutWebhookSigningSecretParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.PutWebhookSigningSecret(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodePutWebhookSigningSecretResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
...
// handleUpdateAppActionRequest handles updateAppAction operation.
//
// PUT /organizations/{organization_id}/app_definitions/{app_definition_id}/actions/{app_action_id}
func (s *Server) handleUpdateAppActionRequest(args [3]string, argsEscaped bool, w http.ResponseWriter, r *http.Request) {
	statusWriter := &codeRecorder{ResponseWriter: w}
	w = statusWriter
	ctx := r.Context()
	...
	)
	{
		...
		var satisfied bitset
		{
			sctx, ok, err := s.securityAccessToken(ctx, UpdateAppActionOperation, r)
			if err != nil {
				err = &ogenerrors.SecurityError{
					OperationContext: opErrContext,
					Security:         "AccessToken",
	...
	params, err := decodeUpdateAppActionParams(args, argsEscaped, r)
	if err != nil {
		err = &ogenerrors.DecodeParamsError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var rawBody []byte
	request, rawBody, close, err := s.decodeUpdateAppActionRequest(r)
	if err != nil {
		err = &ogenerrors.DecodeRequestError{
			OperationContext: opErrContext,
			Err:              err,
	...
	var response UpdateAppActionRes
	if m := s.cfg.Middleware; m != nil {
		mreq := middleware.Request{
			Context:          ctx,
			OperationName:    UpdateAppActionOperation,
			OperationSummary: "",
		...
		type (
			Request  = *AppActionData
			Params   = UpdateAppActionParams
			Response = UpdateAppActionRes
		)
		response, err = middleware.HookMiddleware[
			Request,
			Params,
			...
			m,
			mreq,
			unpackUpdateAppActionParams,
			func(ctx context.Context, request Request, params Params) (response Response, err error) {
				response, err = s.h.UpdateAppAction(ctx, request, params)
				return response, err
			},
		)
	} else {
	...
	if err := encodeUpdateAppActionResponse(response, w); err != nil {
		defer recordError("EncodeResponse", err)
		if !errors.Is(err, ht.ErrInternalServerErrorResponse) {
			s.cfg.ErrorHandler(ctx, w, r, err)
		}
