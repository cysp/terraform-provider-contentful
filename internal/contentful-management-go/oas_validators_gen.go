...
func (s *ContentTypeMetadataAnnotationAssignment) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *ContentTypeMetadataAnnotationAssignmentSys) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s ContentTypeMetadataAnnotationAssignmentSysLinkType) Validate() error {
	switch s {
	case "Annotation":
		return nil
	default:
...
func (s ContentTypeMetadataAnnotationAssignmentSysType) Validate() error {
	switch s {
	case "Link":
		return nil
	default:
...
func (s *ContentTypeMetadataAnnotations) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	if err := func() error {
		if value, ok := s.ContentTypeField.Get(); ok {
			if err := func() error {
				if err := value.Validate(); err != nil {
					return err
				}
...
func (s ContentTypeMetadataAnnotationsContentTypeField) Validate() error {
	var failures []validate.FieldError
