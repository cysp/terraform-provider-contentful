...
func (s *PreviewEnvironmentCollection) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *PreviewEnvironmentCollectionSys) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s PreviewEnvironmentCollectionSysType) Validate() error {
	switch s {
	case "Array":
		return nil
	default:
