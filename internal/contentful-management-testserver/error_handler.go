...
func (e ContentfulManagementErrorHandler) ServeHTTP(responseWriter http.ResponseWriter, _ *http.Request) {
	_ = WriteContentfulManagementResponse(responseWriter, e.StatusCode, &cm.Error{
		Sys: cm.ErrorSys{
