...
var (
	_ list.ListResource              = (*localeResource)(nil)
	_ list.ListResourceWithConfigure = (*localeResource)(nil)
)
...
func (r *localeResource) ListResourceConfigSchema(ctx context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = LocaleListResourceConfigSchema(ctx)
}

func (r *localeResource) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
