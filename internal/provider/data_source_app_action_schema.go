...
func appActionDataSourceAttributes() map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		"url": schema.StringAttribute{
			Description: "Endpoint URL returned by Contentful, or `null` when absent.",
			Computed:    true,
		},
		"function_id": schema.StringAttribute{
			Description: "Linked Function ID returned by Contentful, or `null` when absent.",
			Computed:    true,
		},
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"app_actions": schema.ListNestedAttribute{
				Description: "App Actions in the App Definition, in the order returned by Contentful. An App Definition with no actions returns an empty list.",
				Computed:    true,
