...
func (v EditorInterfaceEditorLayoutItemGroupItemGroupItemFieldValue) ToEditorInterfaceEditorLayoutItem(valuePath path.Path) (cm.EditorInterfaceEditorLayoutItem, diag.Diagnostics) {
...
func (v EditorInterfaceEditorLayoutItemGroupItemFieldValue) ToEditorInterfaceEditorLayoutFieldItem(valuePath path.Path) (cm.EditorInterfaceEditorLayoutFieldItem, diag.Diagnostics) {
	fieldID, diags := requestRequiredString(v.FieldID, valuePath.AtName("field_id"))
	if diags.HasError() {
