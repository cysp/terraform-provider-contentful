...
func (d *localeDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	case *cm.Locale:
		...
		data = LocaleDataSourceModel{
			IDIdentityModel:      responseModel.IDIdentityModel,
			LocaleIdentityModel:  responseModel.LocaleIdentityModel,
			Name:                 responseModel.Name,
			Code:                 responseModel.Code,
			FallbackCode:         responseModel.FallbackCode,
			ContentDeliveryAPI:   responseModel.ContentDeliveryAPI,
