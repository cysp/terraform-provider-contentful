...
func ContentTypeMetadataTaxonomyItemsToContentTypeMetadataTaxonomySlice(
	...
	return convertKnownObjectListElements(
		...
		valuePath,
		items.Elements(),
		func(_ context.Context, itemPath path.Path, value ContentTypeMetadataTaxonomyItemValue) (cm.ContentTypeMetadataTaxonomyItem, diag.Diagnostics) {
			return value.ToContentTypeMetadataTaxonomyItem(itemPath)
		},
	)
}
