...
// Check independently authored requests while the shared server owns CRUD behavior.
func testActionLifecycle(t *testing.T, cases []actionMutationFixture) {
	...
	for _, test := range cases {
		steps = append(steps, resource.TestStep{Config: test.config, ConfigStateChecks: []statecheck.StateCheck{
