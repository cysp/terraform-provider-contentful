	...
	tests := map[string]struct {
		...
		"null": {
			...
			expectedModel: resource_editor_interface.EditorInterfaceModel{
				...
				EditorLayout:  types.ListNull(resource_editor_interface.EditorLayoutValue{}.Type(context.Background())),
				Controls:      types.ListNull(resource_editor_interface.ControlsValue{}.Type(context.Background())),
				GroupControls: types.ListNull(resource_editor_interface.GroupControlsValue{}.Type(context.Background())),
		...
		"empty": {
			...
			expectedModel: resource_editor_interface.EditorInterfaceModel{
				...
				EditorLayout:  util.NewEmptyListMust(resource_editor_interface.EditorLayoutValue{}.Type(context.Background())),
				Controls:      util.NewEmptyListMust(resource_editor_interface.ControlsValue{}.Type(context.Background())),
				GroupControls: util.NewEmptyListMust(resource_editor_interface.GroupControlsValue{}.Type(context.Background())),
