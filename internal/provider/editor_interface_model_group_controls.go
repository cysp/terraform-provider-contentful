...
func (v EditorInterfaceGroupControlValue) ToEditorInterfaceDataGroupControlsItem(valuePath path.Path) (cm.EditorInterfaceDataGroupControlsItem, diag.Diagnostics) {
...
func NewEditorInterfaceGroupControlValueFromResponse(path path.Path, item cm.EditorInterfaceGroupControlsItem) (TypedObject[EditorInterfaceGroupControlValue], diag.Diagnostics) {
	...
	if item.Settings != nil {
		...
		value.Settings = NewNormalizedJSONValue(settings)
	}
