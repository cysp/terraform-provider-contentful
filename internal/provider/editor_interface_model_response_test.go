	...
	tests := map[string]struct {
		...
		"null": {
			...
			expectedModel: provider.EditorInterfaceResourceModel{
				...
				EditorLayout:  types.ListNull(provider.EditorInterfaceEditorLayoutElementValue{}.Type(t.Context())),
		...
		"empty": {
			...
			expectedModel: provider.EditorInterfaceResourceModel{
				...
				EnvironmentID: types.StringValue("environment"),
				ContentTypeID: types.StringValue("content_type"),
				EditorLayout:  types.ListValueMust(provider.EditorInterfaceEditorLayoutElementValue{}.Type(t.Context()), []attr.Value{}),
