...
import (
	...
	"github.com/cysp/terraform-provider-contentful/internal/provider/datasource_preview_api_key"
...
func (d *previewApiKeyDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_preview_api_key"
}

func (d *previewApiKeyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_preview_api_key.PreviewApiKeyDataSourceSchema(ctx)
}
...
func (d *previewApiKeyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_preview_api_key.PreviewApiKeyModel
