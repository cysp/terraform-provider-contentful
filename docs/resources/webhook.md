...
- `http_basic_username` (String) HTTP Basic authentication username. Configure username and password together; both must be null to clear Basic authentication.
