...
| App Event subscription and Function documentation | 2026-09-13; the GET, update/subscribe, and DELETE operation pages and Function guides cited in [Events](events.md#subscription-configuration-observations). |
| App Event subscription configuration probes | [Events](events.md#subscription-configuration-observations) records the observation date, scope, HTTP replacement, and rejected Function request forms. |
